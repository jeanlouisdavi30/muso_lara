...
class caisseVertCtrl extends Controller
{
    ...
    {
        return meettings::select('meettings.title_meetting', 'meettings.id')->join('cotisation_caisses', 'cotisation_caisses.meettings_id', '=', 'meettings.id')
    ...
    public function cotisation_vert()
    {
        ...
        return view('caisseVert.paiement', compact('membre', 'all_mettings', 'last_meetting', 'all_mettings_paiement'));
    }
    ...
    public function rencontre_cotisation(Request $request)
    {
        ...
        $all_mettings_paiement = $this->all_mettings_paiement();
        return view('caisseVert.paiement', compact('membre', 'all_mettings', 'all_mettings_paiement'));
    ...
    public function save_paiement(Request $request)
    {
        ...
        $all_mettings_paiement = $this->all_mettings_paiement();
        return view('caisseVert.paiement', compact('all_mettings', 'success', 'all_mettings_paiement'));
    ...
    public function search_pbc(request $request)
    {
        ...
        return view('caisseVert.paiement', compact('membrePaiemment', 'all_mettings_paiement', 'autorisation', 'all_mettings'));
    }
    ...
    public function save_autre_paiement(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            return view('caisseVert.paiement', compact('error', 'membre', 'all_mettings', 'last_meetting', 'all_mettings_paiement'));
            ...
            if (!empty($check->id)) {
                ...
                $caisse_info = caisse::where('musos_id', $this->id_muso())->first();
                caisse::where('musos_id', $this->id_muso())->update([
                    'caisseVert' => $caisse_info->caisseVert + $request->cotisation,
                ]);
            ...
            return view('caisseVert.paiement', compact('statut', 'membre', 'all_mettings', 'last_meetting', 'all_mettings_paiement'));
        }
    }
