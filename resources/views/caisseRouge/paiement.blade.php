...
if (Request::route()->getName() === 'cotisation-caisse-rouge' or Request::route()->getName() === 'rencontre-cotisation-cr' or Request::route()->getName() === 'paiement-caisse-rouge') {
    $cotisationCV = "active";
} elseif (Request::route()->getName() === 'liste-paiement-ccr') {
    $listpaiement = "active";
} elseif (Request::route()->getName() === 'autre-Paiement' or Request::route()->getName() === 'save-autre-paiement-cr') {
...
<section class="content">
                    ...
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a
                                    ...
                                    href="#cotisationCV" data-toggle="tab">{{__("messages.paiement")}}
                                </a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="<?php if (isset($cotisationCV)) {echo $cotisationCV;}?> tab-pane"
                                ...
                                <!-- /.card-header -->
                                <form method="post" action="{{ route('rencontre-cotisation-cr') }}">
                                    @csrf
    ...
    echo $date->format('d-M-Y');?>
                                ...
                                <form method="post" action="{{ route('paiement-caisse-rouge') }}">
                                    @csrf
                                    <div class="card-body">
    ...
    echo "( " . $date->format('d-M-Y') . " )";?>
                            ...
                            <div class="<?php if (isset($listpaiement)) {echo $listpaiement;}?> tab-pane"
                                id="listpaiement">
                                <!-- /.card-header -->
                                <form method="post" action="{{ route('liste-paiement-ccr') }}">
                                    @csrf
                                    <select name="meettings_id" class="col-md-8 form-control" onchange="form.submit()"
                                        style="margin-left:100px; margin-top:20px;" require>
...
?>
    ...
    $musos = DB::table('cotisation_caisses')
        ...
        ->where('pay', 'true')
        ->first();
    echo " Somme:  " . $musos->count . " " . $curency;
}
?>
                                            </p>
                            ...
                            <div class="<?php if (isset($autrePaiement)) {echo $autrePaiement;}?> tab-pane"
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('save-autre-paiement-cr') }}">
                                        @csrf
...
echo $date->format('d-M-Y');?>
                                        ...
                                        <div class=" form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <label for="inputName" class="col-form-label">Cotisation CR</label>
