                    ...
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link <?php if (isset($retrair)) {echo $retrair;}?>"
                                    href="#cotisationCV" data-toggle="tab">{{__("messages.ajt_sorti")}}
                                </a></li>
                            <?php }?>
                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($list_retrair)) {echo $list_retrair;}?>"
                                    href="#list_retrair" data-toggle="tab">{{__("messages.ales_sorti")}}
                                </a>
                            </li>
                            <?php if (isset($voirDepense)) {?>
                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($voirDepense)) {echo $voirDepense;}?>"
                                    href="#autrePaiement" data-toggle="tab">Sortie Info
                                </a>
                            </li>
                            <?php }?>
...
echo $date->format('d-M-Y');?>
    ...
    echo $date->format('d-M-Y');?>
                                            ...
                                            <li class="list-group-item">
                                                <b>Bénéficiaire</b> <a
                                                    class="float-right">{{$depenses->beneficiare}}</a>
                                            </li>
    ...
    ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="exampleInputEmail1">Bénéficiaire</label>
